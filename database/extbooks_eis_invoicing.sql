...
(47, 10, 'QUO-00001', NULL, 25, 1, 'ZKT Fingerprint & Password Time Attendance Device with Standalone Software', 1, 678.00, 0.00, 1.00, 5.00, 33.90, 678.00, 678.00, 0.00),
(48, 10, 'QUO-00001', NULL, 25, 3, 'ZKT Slave Fingerprint Reader (Door Exit)', 1, 365.00, 0.00, 1.00, 5.00, 18.25, 365.00, 365.00, 0.00),
(49, 10, 'QUO-00001', NULL, 25, 1, 'test', 1, 22.00, 0.00, 1.00, 5.00, 1.10, 22.00, 22.00, 0.00),
(50, 10, 'QUO-00001', NULL, 22, 1, NULL, 10, 100.00, 0.00, 1.00, 5.00, 50.00, 950.00, 1000.00, 0.00),
(51, 12, 'QUO-00001', NULL, 25, 1, 'ZKT Fingerprint & Password Time Attendance Device with Standalone Software', 1, 678.00, 0.00, 1.00, 5.00, 33.90, 678.00, 678.00, 0.00),
(52, 12, 'QUO-00001', NULL, 25, 3, 'ZKT Slave Fingerprint Reader (Door Exit)', 1, 365.00, 0.00, 1.00, 5.00, 18.25, 365.00, 365.00, 0.00),
(53, 12, 'QUO-00001', NULL, 25, 1, 'test', 1, 22.00, 0.00, 1.00, 5.00, 1.10, 22.00, 22.00, 0.00),
(54, 12, 'QUO-00001', NULL, 22, 1, NULL, 10, 100.00, 0.00, 1.00, 5.00, 50.00, 950.00, 1000.00, 0.00);
...
(10, 'QUO-00001', 'IT', 2216, NULL, NULL, 'QUO-R0-E23-00001', 'TaxExclusive', '2023-08-08', '2023-08-08', '2023-08-08', 2065.00, NULL, 103.25, 2065.00, 0.00, 0.00, 0.00, 2168.25, '<ol>\r\n	<li>Cable Pulling, Termination and Configuration.</li>\r\n	<li>Supply, Installation and Configuration of Time attendance System.</li>\r\n</ol>', '<ol>\r\n	<li>Any approval or NOC from any Local Authorities or Government.</li>\r\n	<li>Any extra items not mentioned in contract.</li>\r\n</ol>', '<ol>\r\n	<li>Amount in AED,</li>\r\n</ol>\r\n\r\n<ul style=\"list-style-type:circle\">\r\n	<li>50% Advance (Non-Refundable)</li>\r\n	<li>50% After completion</li>\r\n</ul>\r\n\r\n<ol>\r\n	<li>Quotation valid for 20 days from date of submission.</li>\r\n	<li>One-year warranty for the devices provided by EIS. Liquid and Physical Damage is not covered.</li>\r\n	<li>Any Additional work will be charged as variation.</li>\r\n	<li>Each additional access card will be charged 70 AED which includes Printing, delivery and Configuration of card in the machine.</li>\r\n</ol>', NULL, 1, 'TIME ATTENDANCE SYSTEM', '2023-08-08 11:20:21'),
(12, 'QUO-00001', 'IT', 2216, NULL, NULL, 'QUO-R1-E23-00001', 'TaxExclusive', '2023-08-08', '2023-08-08', '2023-08-08', 2065.00, NULL, 103.25, 2065.00, 0.00, 0.00, 0.00, 2168.25, '<ol>\r\n	<li>Cable Pulling, Termination and Configuration.</li>\r\n	<li>Supply, Installation and Configuration of Time attendance System.</li>\r\n</ol>', '<ol>\r\n	<li>Any approval or NOC from any Local Authorities or Government.</li>\r\n	<li>Any extra items not mentioned in contract.</li>\r\n</ol>', '<ol>\r\n	<li>Amount in AED,</li>\r\n</ol>\r\n\r\n<ul style=\"list-style-type:circle\">\r\n	<li>50% Advance (Non-Refundable)</li>\r\n	<li>50% After completion</li>\r\n</ul>\r\n\r\n<ol>\r\n	<li>Quotation valid for 20 days from date of submission.</li>\r\n	<li>One-year warranty for the devices provided by EIS. Liquid and Physical Damage is not covered.</li>\r\n	<li>Any Additional work will be charged as variation.</li>\r\n	<li>Each additional access card will be charged 70 AED which includes Printing, delivery and Configuration of card in the machine.</li>\r\n</ol>', NULL, 1, 'TIME ATTENDANCE SYSTEM', '2023-08-16 06:14:57');
...
INSERT INTO `invoice_detail` (`InvoiceDetailID`, `InvoiceMasterID`, `InvoiceNo`, `ItemID`, `ItemCategoryID`, `Description`, `SupplierID`, `PartyID`, `Qty`, `Rate`, `TaxPer`, `Tax`, `Discount`, `DiscountType`, `DiscountAmountItem`, `Gross`, `Total`) VALUES
(13, 4, 'INV-00001', 25, 1, 'ZKT Fingerprint & Password Time Attendance Device with Standalone Software', NULL, 2216, 1, 678.00, 5.00, 33.90, 0.00, 0.00, 0.00, 678.00, 678.00),
(14, 4, 'INV-00001', 25, 3, 'ZKT Slave Fingerprint Reader (Door Exit)', NULL, 2216, 1, 365.00, 5.00, 18.25, 0.00, 0.00, 0.00, 365.00, 365.00),
(15, 4, 'INV-00001', 25, 1, 'test', NULL, 2216, 1, 22.00, 5.00, 1.10, 0.00, 0.00, 0.00, 22.00, 22.00),
(16, 4, 'INV-00001', 22, 1, NULL, NULL, 2216, 10, 100.00, 5.00, 50.00, 0.00, 0.00, 0.00, 1000.00, 950.00);
...
CREATE TABLE `invoice_master` (
  ...
  `EstimateReferenceNo` varchar(255) DEFAULT NULL,
  `UserID` int DEFAULT NULL,
...
INSERT INTO `invoice_master` (`InvoiceMasterID`, `InvoiceNo`, `InvoiceType`, `Date`, `DueDate`, `PartyID`, `WalkinCustomerName`, `SupplierID`, `ReferenceNo`, `EstimateReferenceNo`, `UserID`, `PaymentMode`, `PaymentDetails`, `Subject`, `TaxType`, `DescriptionNotes`, `CustomerNotes`, `SubTotal`, `DiscountPer`, `Total`, `DiscountAmount`, `TaxPer`, `Tax`, `Shipping`, `GrandTotal`, `Paid`, `Balance`) VALUES
(4, 'INV-00001', 'Invoice', '2023-08-16', NULL, 2216, NULL, NULL, 'INV-E23-00001', 'QUO-R1-E23-00001', 1, 'Cash', NULL, 'TIME ATTENDANCE SYSTEM', 'TaxExclusive', '<ol>\r\n	<li>Any approval or NOC from any Local Authorities or Government.</li>\r\n	<li>Any extra items not mentioned in contract.</li>\r\n</ol>', '<ol>\r\n	<li>Cable Pulling, Termination and Configuration.</li>\r\n	<li>Supply, Installation and Configuration of Time attendance System.</li>\r\n</ol>', 2065.00, 0.00, 2065.00, 0.00, NULL, 103.25, 0.00, 2168.25, 0.00, NULL);
...
(20, 'INV-00001', NULL, 110400, 2216, NULL, NULL, NULL, 4, NULL, NULL, NULL, 'TIME ATTENDANCE SYSTEM', '2023-08-16', 2168.25, NULL, '123', NULL, NULL),
(21, 'INV-00001', NULL, 410100, 2216, NULL, NULL, NULL, 4, NULL, NULL, NULL, 'TIME ATTENDANCE SYSTEM', '2023-08-16', NULL, 2065.00, '12345', NULL, NULL),
(22, 'INV-00001', NULL, 210300, 2216, NULL, NULL, NULL, 4, NULL, NULL, NULL, 'TIME ATTENDANCE SYSTEM', '2023-08-16', NULL, 103.25, '12346', NULL, NULL),
(31, 'PAY-3', 'CP', 110101, 2216, NULL, NULL, NULL, 4, NULL, 3, NULL, 'Payment made with payment refno 3', '2023-08-16', 2168.25, NULL, '514', NULL, NULL),
(32, 'PAY-3', 'CP', 110400, 2216, NULL, NULL, NULL, 4, NULL, 3, NULL, 'Payment made with payment refno 3', '2023-08-16', NULL, 2168.25, '515', NULL, NULL);
...
(11, 3, '2023-08-16', 4, 2168.25, '2023-08-16 07:02:09');
...
(3, 2216, '2023-08-16', 2168.25, 'Cash', 110201, 'R1-E23-00001-1', NULL, NULL, '2023-08-16 07:00:27');
...
--
ALTER TABLE `estimate_detail`
  MODIFY `EstimateDetailID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `estimate_master`
--
ALTER TABLE `estimate_master`
  MODIFY `EstimateMasterID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `invoice_detail`
  MODIFY `InvoiceDetailID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `invoice_master`
--
ALTER TABLE `invoice_master`
  MODIFY `InvoiceMasterID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `journal`
  MODIFY `JournalID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `payment_detail`
  MODIFY `PaymentDetailID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `payment_master`
--
ALTER TABLE `payment_master`
  MODIFY `PaymentMasterID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
