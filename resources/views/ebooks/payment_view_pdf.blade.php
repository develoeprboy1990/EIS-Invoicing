...
<body class="invoice">
    ...
    <table class="order-details">
        <tfoot>
            ...
            <tr class="pcs-itemtable-header" style="font-weight: bold;">
                <th colspan="4" align="center">Grand Total Paid</th>
                <td style="text-align:center!important;">{{number_format($dueBalance->PAID,2)}}</td>
            </tr>

            <tr class="pcs-itemtable-header" style="font-weight: bold;">
                <th colspan="4" align="center">Balance</th>
                <td style="text-align:center!important;">{{number_format($dueBalance->due,2)}}</td>
            </tr>
